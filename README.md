...
| [inform_note-domain](file:///d:/inform-note-workspace/inform-note/inform_note-domain) | `DownEventCard`, `DownContent`, VO, Enum, 도메인 CRUD, MyBatis Mapper | `inform_note-base`, MyBatis, Oracle JDBC |
